...
<body>
    ...
    <% 
        ...
        if (customerID == null) {
            ...
            // Fetch past reservations for the customer (i.e., where the status is not "Confirmed")
            ApplicationDB db = new ApplicationDB();
            Connection con = db.getConnection();

            String query = "SELECT r.ReservationID, r.ScheduleID, r.SeatsReserved, r.ReservationStatus, r.Price, " +
                           "ts.OriginStationID, ts.DestinationStationID, ts.DepartureTime, ts.ArrivalTime " +
                           "FROM Reservations r " +
    ...
    <!-- Display past reservations in a table -->
    <table>
        <tr>
